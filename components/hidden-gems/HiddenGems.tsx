...
const hiddenGems = [
  {
    name: "Majuli",
    state: "Assam",
    description: "A river island shaped by culture, monasteries and the Brahmaputra.",
    image:
  ...
  },
  {
    ...
    description: "Quiet valleys, green landscapes and a world that moves slowly.",
    image:
  ...
  },
  {
    name: "Mawlynnong",
    state: "Meghalaya",
    description: "A peaceful village surrounded by rain, forests and living traditions.",
    image:
  ...
  },
  {
    ...
    description: "High-altitude roads, dramatic mountains and endless Himalayan silence.",
    image:
      "https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?auto=format&fit=crop&w=900&q=85",
    slug: "spiti-valley",
  },
      ...
      <div className="mx-auto max-w-[1440px]">
       ...
       <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {hiddenGems.map((place, index) => (
                ...
                className={`group relative block overflow-hidden rounded-3xl bg-[#211c17] ${
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <div
                        className="mb-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-[#211c17] transition duration-300 group-hover:rotate-45"
