...
export default function DestinationCard({
  ...
  return (
    <Link
      ...
      className="group relative h-[420px] w-[280px] shrink-0 overflow-hidden rounded-3xl bg-[#1f1b18] sm:w-[320px]"
    >
      {/* Image */}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
        ...
        <div
          className="absolute bottom-6 right-6 flex h-11 w-11 items-center justify-center rounded-full bg-white text-[#1f1b18] transition duration-300 group-hover:rotate-45"
